...
const ResetPasswordPage = () => {
  ...
  const handleResetSubmit = async (e) => {
    ...
    if (error) {
      toast({ title: "Error al Restablecer", description: "El enlace puede haber expirado o ser inválido. Por favor, solicita uno nuevo.", variant: "destructive" });
    } else {
      setSubmitted(true);
        ...
        <CardContent>
          {submitted ? (
            ...
            >
              ...
              <p className="text-indigo-200">
                Este enlace de recuperación no es válido. Puede que haya expirado o ya haya sido utilizado.
              </p>
